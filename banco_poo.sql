...
--
-- Host: localhost    Database: banco_poo
-- ------------------------------------------------------
...
CREATE TABLE `clientes` (
  ...
  UNIQUE KEY `nome_titular_UNIQUE` (`nome_titular`)
...
--
-- Dumping events for database 'banco_poo'
--

--
-- Dumping routines for database 'banco_poo'
--
...
-- Dump completed on 2022-12-13 10:05:07
